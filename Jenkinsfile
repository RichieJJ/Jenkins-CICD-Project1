...
pipeline {
    ...
    stage('SonarQube Scan') {
      steps {
        sh """mvn sonar:sonar \
              ...
              -Dsonar.host.url=http://52.91.214.184:9000 \
              -Dsonar.login=6d5fef904b1e97453d881619d2340e6965c6792b"""
      }
    }
  ...
  post {
    always {
        ...
        slackSend channel: '#richie-jenkins-cicd-pipeline-alerts', //update and provide your channel name
